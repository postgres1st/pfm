...
Volumes could be pre-provisioned and dynamic. Postgres1st WatchTower chart supports both and exposes it through [Postgres1st WatchTower storage configuration](https://github.com/percona/percona-helm-charts/tree/main/charts/pmm#pmm-storage-configuration).
...
1. Identify the current Postgres1st WatchTower version (for restoration purposes):
...
6. Verify that PMM Server is running again:
    ...
    !!! note "Postgres1st WatchTower scale"
