...
Volumes could be pre-provisioned and dynamic. PGF WatchTower chart supports both and exposes it through [PGF WatchTower storage configuration](https://github.com/percona/percona-helm-charts/tree/main/charts/pmm#pmm-storage-configuration).
...
1. Identify the current PGF WatchTower version (for restoration purposes):
