...
- Knowledge of the Postgres1st WatchTower version used in the backup
...
2. Wait for resources to be cleaned up:
    ...
    ```
3. Restore PMM Server using the snapshot as a data source, replacing 3.1.0 with a Postgres1st WatchTower version that is equal to or newer than the version used in the backup:
