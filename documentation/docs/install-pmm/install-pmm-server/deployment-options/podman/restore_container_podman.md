...
2. Run Postgres1st WatchTower on the previous image, replacing `x.yy.z` with the specific version you were using when you created the backup. Using the same version ensures compatibility with your backup data.
