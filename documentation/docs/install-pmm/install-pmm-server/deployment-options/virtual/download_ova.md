...
!!! warning "OVF support ending in PFMM 3.9.0"
    OVF/OVA distribution is deprecated starting with PFMM 3.7.0 and will be removed in PFMM 3.9.0 (expected July 2026). No new OVA images will be published after that release. Migrate to [Docker](../docker/index.md) or another supported deployment method before PFMM 3.9.0.
...
=== "Download from the UI"
    ...
    2. Make sure PFMM 3 is selected, then choose a PFMM version and select **SERVER - VIRTUAL APPLIANCE OVF**.
