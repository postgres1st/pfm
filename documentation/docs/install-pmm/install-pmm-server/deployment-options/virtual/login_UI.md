...
To log in to the Postgres1st WatchTower user interface:
{.power-number}
...
2. The Postgres1st WatchTower [Login screen](../../../../reference/ui/log_in.md) appears.
...
5. The Postgres1st WatchTower Home dashboard appears.
...
??? info "(Optional) Set up SSH from UI/CLI"
    ...
    2. Log into the Postgres1st WatchTower user interface.
