...
To log in to the PGF WatchTower user interface:
{.power-number}
...
2. The PGF WatchTower [Login screen](../../../../reference/ui/log_in.md) appears.
...
5. The PGF WatchTower Home dashboard appears.
...
??? info "(Optional) Set up SSH from UI/CLI"
    ...
    2. Log into the PGF WatchTower user interface.
