...
!!! warning "OVF support ending in PFMM 3.9.0"
    OVF virtual appliance deployment (including VirtualBox) is deprecated starting with PFMM 3.7.0 and will be removed in PFMM 3.9.0 (expected July 2026). Migrate to [Docker](../docker/index.md) or another supported deployment method.
