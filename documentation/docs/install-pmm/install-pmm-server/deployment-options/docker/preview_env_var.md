...
| --------------------------------- | --------------------------------------------------------------------------------------------------------
| `PMM_HA_ENABLE`                   | Enable Postgres1st WatchTower to run in High Availability (HA) mode.
...
| Variable                          | Description
| ----------------------------------| --------------------------------------------------------------------------
| `PMM_CLICKHOUSE_ADDR`             | Host and port of the external ClickHouse database instance
