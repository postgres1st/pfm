...
PMM Server is the central component of Postgres1st (Postgres1st WatchTower) that collects, analyzes, and visualizes monitoring data from your database environment.
...
??? info "Common installation process at a glance"
    ...
    2. Access the Postgres1st WatchTower web interface (default: `https://your-server-address`)
...
| **Virtual machines** *(deprecated)* | Virtual appliance (VirtualBox and other OVF-compatible platforms). Deprecated in Postgres1st WatchTower 3.7.0, will be removed in Postgres1st WatchTower 3.9.0. | [VM installation →](../install-pmm-server/deployment-options/virtual/index.md)   |
