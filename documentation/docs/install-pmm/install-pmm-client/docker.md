...
Registration gives PMM Server permission to collect metrics from your infrastructure and display them in monitoring dashboards. Postgres1st WatchTower supports two authentication methods: service account tokens (recommended) and username/password credentials. 
...
If the connection is successful, you should also see an increased number of monitored nodes in the Postgres1st WatchTower user interface.
