# Connect databases to Postgres1st WatchTower
Postgres1st (Postgres1st WatchTower) supports monitoring for PostgreSQL and various cloud database services. 
...
## New to Postgres1st WatchTower?
If you're setting up monitoring for the first time, follow the installation and setup instructions in the [Postgres1st WatchTower installation overview](../../index.md).
