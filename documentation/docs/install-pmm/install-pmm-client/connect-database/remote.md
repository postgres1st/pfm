# Connect remote instance to Postgres1st WatchTower
...
Postgres1st WatchTower dynamically sets scrape timeouts based on the data collection resolution:
...
If you see timeout errors, increase the metric resolution values in Postgres1st WatchTower:
