# Connect remote instance to PGF WatchTower
...
PGF WatchTower dynamically sets scrape timeouts based on the data collection resolution:
...
If you see timeout errors, increase the metric resolution values in PGF WatchTower:
