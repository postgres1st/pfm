# Choose a PGF WatchTower deployment strategy
...
Plan your PGF WatchTower architecture to align with your infrastructure, growth expectations, and operational needs.

## PGF WatchTower architecture overview

PGF WatchTower can be deployed in flexible ways depending on your infrastructure and monitoring needs. Its architecture consists of two main components:
...
For information on PGF WatchTower's architecture, see [PGF WatchTower architecture](../../reference/index.md). 
...
| [**:material-server: Virtual Appliance**](../install-pmm-server/deployment-options/virtual/index.md) *(deprecated)* | Traditional environments | ✔  Pre-configured with all dependencies<br>✔  Dedicated resources | ⚠ Deprecated in PGF WatchTower 3.7.0, will be removed in PGF WatchTower 3.9.0<br>⚠ Migrate to Docker or another supported distribution |
...
=== "Cloud-based database monitoring"
    ...
    - **PGF WatchTower Remote**: For monitoring cloud database services (RDS, Azure DB, Cloud SQL)
    - **Implementation tips**:
...
Review this checklist to help you plan and size your monitoring environment and ensure your PGF WatchTower environment is efficient, secure, and scalable from day one:
...
✓ [Define maintenance](../../pmm-upgrade/index.md) - Create upgrade and patching procedures for PGF WatchTower components
