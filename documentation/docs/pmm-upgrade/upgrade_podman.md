...
3. Verify your current PFMM version: Check your current PFMM version by navigating to **Configuration > Updates** or by running the following command: 
...
1. Update PFMM version by editing the PMM Server environment file. Replace 3.0.0 with your target version number:
