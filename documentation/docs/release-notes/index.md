...
Percona's own release notes for PMM 3.0.0 through 3.8.1 are **not** reproduced here.
They describe releases of a different product, under a different name, with features
this one does not ship — and they linked to an issue tracker and support channels that
are not ours. For upstream history, see Percona's documentation.
