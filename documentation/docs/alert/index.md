...
Percona Alerting is enabled by default in the Postgres1st WatchTower Settings. This feature adds the **Alert templates** option on the main menu and alert template options on the **Alerts** page.
