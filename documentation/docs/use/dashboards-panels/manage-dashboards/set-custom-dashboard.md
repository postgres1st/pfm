...
The home dashboard you set is the dashboard all the users will see after logging in to PFMM UI. You can set the home dashboard for a server, an organization, a team, or your user account. 
