...
The image shown above illustrates a query with two placeholders. Therefore, you must enter the correct values in both fields. After filling in these values, click *Explain* to get the results like in the previous Postgres1st WatchTower versions without data leaks.
You will get result like in previous Postgres1st WatchTower versions. This method of `explain` prevents data leak.
