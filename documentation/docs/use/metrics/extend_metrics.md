...
| Resolution | Folder                                                                    |
|------------|---------------------------------------------------------------------------|
|  High      | `/opt/postgres1st/pfm/collectors/textfile-collector/high-resolution`   |
|  Medium    | `/opt/postgres1st/pfm/collectors/textfile-collector/medium-resolution` |
|  Low       | `/opt/postgres1st/pfm/collectors/textfile-collector/low-resolution`    |
...
```sh
echo 'node_role{role="my_monitored_server_1"} 1' > /opt/postgres1st/pfm/collectors/textfile-collector/low-resolution/node_role.prom
```
...
*/1 * * * *     root    /usr/bin/who | /usr/bin/wc -l | sed -ne 's/^/node_loggedin_users /p' > /opt/postgres1st/pfm/collectors/textfile-collector/high-resolution/node_users.prom
```
