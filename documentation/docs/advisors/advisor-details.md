...
Postgres1st (PGF WatchTower) offers four categories of database advisors to help you improve database performance: Configuration, Performance, Query and Security advisors.
