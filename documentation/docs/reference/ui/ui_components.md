...
This section explains how to access the interface, navigate the layout, and use the various controls within Postgres1st WatchTower.

Here's how the UI is laid out, and what the controls do:

![Postgres1st WatchTower Interface with numbered components](../../images/PMM_Home_Dashboard_Numbered.png)
...
| :material-flask-outline: | Inventory | View and manage all monitored nodes, services, and agents registered in Postgres1st WatchTower. Check database and agent status, organize services by clusters, and add or remove monitored instances. |
...
| :material-account-circle-outline:| Account | Manage your user profile settings, change your password, set notification preferences, and configure your personal Postgres1st WatchTower experience. |
| :material-help-circle-outline:| Help | Access Postgres1st WatchTower documentation, community forums, and support resources. Export diagnostic logs for troubleshooting and view version information.|
...
- **Export**: Download the dashboard as a JSON file for backup or import into another Postgres1st WatchTower instance. 
...
- **Postgres1st WatchTower Annotations**: Toggle visibility of important events on your timelines
