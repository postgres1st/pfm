...
Set labels when adding a service with `pfw-admin`:

```sh
# Set standard labels
pfw-admin add mysql --replication-set=MySet1 --environment=production ...
...
- [pfw-admin add](../use/commands/pmm-admin/add.md)
