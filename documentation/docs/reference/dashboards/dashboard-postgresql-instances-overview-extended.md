...
### Services
Shows how many PostgreSQL services you're currently monitoring with Postgres1st WatchTower. This gives you a quick count of all active database instances under management across your infrastructure.
