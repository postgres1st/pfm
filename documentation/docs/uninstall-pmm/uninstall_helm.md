# Uninstall Postgres1st WatchTower using Helm
...
- Permissions to manage resources in the namespace where Postgres1st WatchTower is deployed
...
1. Uninstall the `pmm` Helm release and remove all resources associated with the Postgres1st WatchTower release and the release history:
