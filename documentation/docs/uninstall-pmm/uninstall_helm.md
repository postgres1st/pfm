# Uninstall PGF WatchTower using Helm
...
- Permissions to manage resources in the namespace where PGF WatchTower is deployed
...
1. Uninstall the `pmm` Helm release and remove all resources associated with the PGF WatchTower release and the release history:
