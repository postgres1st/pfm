# User management in PFMM

User management controls who can access PFMM and what actions they can perform. Every user who logs into PFMM has a specific role assigned, which determines their permissions.

User management defines who can access PFMM and what actions they are allowed to perform:
- **Users**: Individual accounts that can log in to PFMM with unique credentials.
...
User capabilities depend entirely on the role assigned to them. For a comprehensive overview of available roles and their associated permissions, see [Access control in PFMM](../roles/access-control/intro.md).

## Next steps

[Access control in PFMM :material-arrow-right:](../roles/access-control/intro.md){.md-button}
