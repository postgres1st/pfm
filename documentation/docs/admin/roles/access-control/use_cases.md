...
Here are a few practical examples of how label-based access control can be implemented in Postgres1st WatchTower to meet specific organizational needs.

## Infrastructure overview
The diagram below shows a sample infrastructure monitored by Postgres1st WatchTower. Notice how the metrics stored in VictoriaMetrics include labels like **environment** and **region** that can be used for access control.

  <!-- source: https://miro.com/app/board/uXjVPfHchvM=/ -->
  ![Postgres1st WatchTower Access Control - Metrics collection](../../../images/lbac/pmm-lbac-collect-metrics.jpg)

## Use case 1: Simple selectors

This scenario demonstrates how to create three distinct roles with different levels of access:

![Postgres1st WatchTower Access Control - Basic Roles](../../../images/lbac/pmm-lbac-query-metrics-1.jpg)
...
<!-- source: https://miro.com/app/board/uXjVPfHchvM=/ -->
![Postgres1st WatchTower Access Control - Roles](../../../images/lbac/pmm-lbac-query-metrics-2.jpg)
