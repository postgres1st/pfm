...
Postgres1st (PGF WatchTower) is an industry leading tool for helping Devs, DevOps, and DBA's make sense of and take action on their database environments. While you can accomplish many tasks using either the PGF WatchTower user interface or CLI, leveraging the API allows you to integrate it more easily into your broader technology infrastructure.
...
To give you an idea of what you can do with PGF WatchTower api, you can:

- [add database instances](ref:addservice) to monitoring, be it MySQL, PostgreSQL, or MongoDB
- [check](ref:checkupdates) the availability of PGF WatchTower updates
- [update](ref:startupdate) PGF WatchTower and [check](ref:updatestatus) the status of the update
