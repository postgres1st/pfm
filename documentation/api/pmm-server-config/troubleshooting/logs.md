...
3. Through the UI, by selecting the **Help > PFMM Logs** option from the main menu.
  If you need to share logs with Percona Support via an SFTP server, you can also use the **PFMM Dump** option from the Help menu to generate a compressed tarball file with an export of your PFMM metrics and QAN data.
  For more information, see [Export PFMM data with PFMM Dump](https://docs.percona.com/percona-monitoring-and-management/3/troubleshoot/pmm_dump.html) topic in the product documentation.
