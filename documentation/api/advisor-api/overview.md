...
- [List Percona Advisors](ref:listadvisors) lists all Advisors available for your PFMM instance.
- [List Advisor Checks](ref:listadvisorchecks) lists all Advisor Checks available in your PFMM.
