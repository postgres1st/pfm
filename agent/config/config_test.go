...
func TestGet(t *testing.T) {
	t.Run("OnlyFlags", func(t *testing.T) {
		...
		expected := Config{
			...
			Paths: Paths{
				PathsBase:        "/opt/postgres1st/watchtower",
				ExportersBase:    "/opt/postgres1st/watchtower/exporters",
				NodeExporter:     "/opt/postgres1st/watchtower/exporters/node_exporter",
				MySQLdExporter:   "/opt/postgres1st/watchtower/exporters/mysqld_exporter",
				MongoDBExporter:  "/opt/postgres1st/watchtower/exporters/mongodb_exporter",
				PostgresExporter: "/opt/postgres1st/watchtower/exporters/postgres_exporter",
				ProxySQLExporter: "/opt/postgres1st/watchtower/exporters/proxysql_exporter",
				RDSExporter:      "/opt/postgres1st/watchtower/exporters/rds_exporter",
				AzureExporter:    "/opt/postgres1st/watchtower/exporters/azure_exporter",
				ValkeyExporter:   "/opt/postgres1st/watchtower/exporters/valkey_exporter",
				VMAgent:          "/opt/postgres1st/watchtower/exporters/vmagent",
				TempDir:          "/opt/postgres1st/watchtower/tmp",
				NomadDataDir:     "/opt/postgres1st/watchtower/data/nomad",
				PTSummary:        "/opt/postgres1st/watchtower/tools/pt-summary",
				PTPGSummary:      "/opt/postgres1st/watchtower/tools/pt-pg-summary",
				PTMySQLSummary:   "/opt/postgres1st/watchtower/tools/pt-mysql-summary",
				PTMongoDBSummary: "/opt/postgres1st/watchtower/tools/pt-mongodb-summary",
				Nomad:            "/opt/postgres1st/watchtower/tools/nomad",
			},
