...
func TestGet(t *testing.T) {
	t.Run("OnlyFlags", func(t *testing.T) {
		...
		expected := Config{
			...
			Paths: Paths{
				PathsBase:        "/opt/postgres1st/pfm",
				ExportersBase:    "/opt/postgres1st/pfm/exporters",
				NodeExporter:     "/opt/postgres1st/pfm/exporters/node_exporter",
				MySQLdExporter:   "/opt/postgres1st/pfm/exporters/mysqld_exporter",
				MongoDBExporter:  "/opt/postgres1st/pfm/exporters/mongodb_exporter",
				PostgresExporter: "/opt/postgres1st/pfm/exporters/postgres_exporter",
				ProxySQLExporter: "/opt/postgres1st/pfm/exporters/proxysql_exporter",
				RDSExporter:      "/opt/postgres1st/pfm/exporters/rds_exporter",
				AzureExporter:    "/opt/postgres1st/pfm/exporters/azure_exporter",
				ValkeyExporter:   "/opt/postgres1st/pfm/exporters/valkey_exporter",
				VMAgent:          "/opt/postgres1st/pfm/exporters/vmagent",
				TempDir:          "/opt/postgres1st/pfm/tmp",
				NomadDataDir:     "/opt/postgres1st/pfm/data/nomad",
				PTSummary:        "/opt/postgres1st/pfm/tools/pt-summary",
				PTPGSummary:      "/opt/postgres1st/pfm/tools/pt-pg-summary",
				PTMySQLSummary:   "/opt/postgres1st/pfm/tools/pt-mysql-summary",
				PTMongoDBSummary: "/opt/postgres1st/pfm/tools/pt-mongodb-summary",
				Nomad:            "/opt/postgres1st/pfm/tools/nomad",
			},
