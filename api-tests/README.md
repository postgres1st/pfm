...
1. Run a PFMM server. This can be done by running `make env-up` in the repository root.
...
where `PMM_SERVER_URL` should be pointing to a running PFMM server. The variable keeps
