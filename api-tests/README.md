...
API tests for PGF WatchTower 3.x
...
1. Run a PGF WatchTower server. This can be done by running `make env-up` in the repository root.
...
where `PMM_SERVER_URL` should be pointing to a running PGF WatchTower server. The variable keeps
