...
type GetAgentDefaultBodyDetailsItems0 struct {
	...
	GetAgentDefaultBodyDetailsItems0 map[string]any `json:"-"`
}
...
type GetAgentOKBody struct {
	...
	// nomad agent
	NomadAgent *GetAgentOKBodyNomadAgent `json:"nomad_agent,omitempty"`
	...
	// rta mongodb agent
	RtaMongodbAgent *GetAgentOKBodyRtaMongodbAgent `json:"rta_mongodb_agent,omitempty"`
...
func (o *GetAgentOKBody) validateNomadAgent(formats strfmt.Registry) error {
	...
	if o.NomadAgent != nil {
		if err := o.NomadAgent.Validate(formats); err != nil {
			ve := new(errors.Validation)
			if stderrors.As(err, &ve) {
				return ve.ValidateName("getAgentOk" + "." + "nomad_agent")
			}
			ce := new(errors.CompositeError)
			if stderrors.As(err, &ce) {
				return ce.ValidateName("getAgentOk" + "." + "nomad_agent")
			}
...
func (o *GetAgentOKBody) validateRtaMongodbAgent(formats strfmt.Registry) error {
	...
	if o.RtaMongodbAgent != nil {
		if err := o.RtaMongodbAgent.Validate(formats); err != nil {
			ve := new(errors.Validation)
			if stderrors.As(err, &ve) {
				return ve.ValidateName("getAgentOk" + "." + "rta_mongodb_agent")
			}
			ce := new(errors.CompositeError)
			if stderrors.As(err, &ce) {
				return ce.ValidateName("getAgentOk" + "." + "rta_mongodb_agent")
			}
...
func (o *GetAgentOKBody) contextValidateNomadAgent(ctx context.Context, formats strfmt.Registry) error {
...
func (o *GetAgentOKBody) contextValidateRtaMongodbAgent(ctx context.Context, formats strfmt.Registry) error {
...
var getAgentOkBodyExternalExporterTypeStatusPropEnum []any
...
func init() {
	...
	for _, v := range res {
		getAgentOkBodyExternalExporterTypeStatusPropEnum = append(getAgentOkBodyExternalExporterTypeStatusPropEnum, v)
	}
}

const (

	// GetAgentOKBodyExternalExporterStatusAGENTSTATUSUNSPECIFIED captures enum value "AGENT_STATUS_UNSPECIFIED"
	GetAgentOKBodyExternalExporterStatusAGENTSTATUSUNSPECIFIED string = "AGENT_STATUS_UNSPECIFIED"

	// GetAgentOKBodyExternalExporterStatusAGENTSTATUSSTARTING captures enum value "AGENT_STATUS_STARTING"
	GetAgentOKBodyExternalExporterStatusAGENTSTATUSSTARTING string = "AGENT_STATUS_STARTING"

	// GetAgentOKBodyExternalExporterStatusAGENTSTATUSINITIALIZATIONERROR captures enum value "AGENT_STATUS_INITIALIZATION_ERROR"
	GetAgentOKBodyExternalExporterStatusAGENTSTATUSINITIALIZATIONERROR string = "AGENT_STATUS_INITIALIZATION_ERROR"

	// GetAgentOKBodyExternalExporterStatusAGENTSTATUSRUNNING captures enum value "AGENT_STATUS_RUNNING"
	GetAgentOKBodyExternalExporterStatusAGENTSTATUSRUNNING string = "AGENT_STATUS_RUNNING"

	// GetAgentOKBodyExternalExporterStatusAGENTSTATUSWAITING captures enum value "AGENT_STATUS_WAITING"
	GetAgentOKBodyExternalExporterStatusAGENTSTATUSWAITING string = "AGENT_STATUS_WAITING"

	// GetAgentOKBodyExternalExporterStatusAGENTSTATUSSTOPPING captures enum value "AGENT_STATUS_STOPPING"
	GetAgentOKBodyExternalExporterStatusAGENTSTATUSSTOPPING string = "AGENT_STATUS_STOPPING"

	// GetAgentOKBodyExternalExporterStatusAGENTSTATUSDONE captures enum value "AGENT_STATUS_DONE"
	GetAgentOKBodyExternalExporterStatusAGENTSTATUSDONE string = "AGENT_STATUS_DONE"

	// GetAgentOKBodyExternalExporterStatusAGENTSTATUSUNKNOWN captures enum value "AGENT_STATUS_UNKNOWN"
	GetAgentOKBodyExternalExporterStatusAGENTSTATUSUNKNOWN string = "AGENT_STATUS_UNKNOWN"
)

// prop value enum
func (o *GetAgentOKBodyExternalExporter) validateStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, getAgentOkBodyExternalExporterTypeStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *GetAgentOKBodyExternalExporter) validateStatus(formats strfmt.Registry) error {
	if swag.IsZero(o.Status) { // not required
		return nil
	}

	// value enum
	if err := o.validateStatusEnum("getAgentOk"+"."+"external_exporter"+"."+"status", "body", *o.Status); err != nil {
		return err
	}
...
/*
GetAgentOKBodyNomadAgent get agent OK body nomad agent
swagger:model GetAgentOKBodyNomadAgent
*/
type GetAgentOKBodyNomadAgent struct {
...
// Validate validates this get agent OK body nomad agent
func (o *GetAgentOKBodyNomadAgent) Validate(formats strfmt.Registry) error {
	var res []error
...
var getAgentOkBodyNomadAgentTypeStatusPropEnum []any
...
func init() {
	...
	for _, v := range res {
		getAgentOkBodyNomadAgentTypeStatusPropEnum = append(getAgentOkBodyNomadAgentTypeStatusPropEnum, v)
	}
}

const (

	// GetAgentOKBodyNomadAgentStatusAGENTSTATUSUNSPECIFIED captures enum value "AGENT_STATUS_UNSPECIFIED"
	GetAgentOKBodyNomadAgentStatusAGENTSTATUSUNSPECIFIED string = "AGENT_STATUS_UNSPECIFIED"

	// GetAgentOKBodyNomadAgentStatusAGENTSTATUSSTARTING captures enum value "AGENT_STATUS_STARTING"
	GetAgentOKBodyNomadAgentStatusAGENTSTATUSSTARTING string = "AGENT_STATUS_STARTING"

	// GetAgentOKBodyNomadAgentStatusAGENTSTATUSINITIALIZATIONERROR captures enum value "AGENT_STATUS_INITIALIZATION_ERROR"
	GetAgentOKBodyNomadAgentStatusAGENTSTATUSINITIALIZATIONERROR string = "AGENT_STATUS_INITIALIZATION_ERROR"

	// GetAgentOKBodyNomadAgentStatusAGENTSTATUSRUNNING captures enum value "AGENT_STATUS_RUNNING"
	GetAgentOKBodyNomadAgentStatusAGENTSTATUSRUNNING string = "AGENT_STATUS_RUNNING"

	// GetAgentOKBodyNomadAgentStatusAGENTSTATUSWAITING captures enum value "AGENT_STATUS_WAITING"
	GetAgentOKBodyNomadAgentStatusAGENTSTATUSWAITING string = "AGENT_STATUS_WAITING"

	// GetAgentOKBodyNomadAgentStatusAGENTSTATUSSTOPPING captures enum value "AGENT_STATUS_STOPPING"
	GetAgentOKBodyNomadAgentStatusAGENTSTATUSSTOPPING string = "AGENT_STATUS_STOPPING"

	// GetAgentOKBodyNomadAgentStatusAGENTSTATUSDONE captures enum value "AGENT_STATUS_DONE"
	GetAgentOKBodyNomadAgentStatusAGENTSTATUSDONE string = "AGENT_STATUS_DONE"

	// GetAgentOKBodyNomadAgentStatusAGENTSTATUSUNKNOWN captures enum value "AGENT_STATUS_UNKNOWN"
	GetAgentOKBodyNomadAgentStatusAGENTSTATUSUNKNOWN string = "AGENT_STATUS_UNKNOWN"
)

// prop value enum
func (o *GetAgentOKBodyNomadAgent) validateStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, getAgentOkBodyNomadAgentTypeStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *GetAgentOKBodyNomadAgent) validateStatus(formats strfmt.Registry) error {
	if swag.IsZero(o.Status) { // not required
		return nil
	}

	// value enum
	if err := o.validateStatusEnum("getAgentOk"+"."+"nomad_agent"+"."+"status", "body", *o.Status); err != nil {
		return err
	}
...
// ContextValidate validates this get agent OK body nomad agent based on context it is used
func (o *GetAgentOKBodyNomadAgent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetAgentOKBodyNomadAgent) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetAgentOKBodyNomadAgent) UnmarshalBinary(b []byte) error {
	var res GetAgentOKBodyNomadAgent
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetAgentOKBodyQANMongodbMongologAgent QANMongoDBMongologAgent runs within pfw-agent and sends MongoDB Query Analytics data to the Postgres1st WatchTower Server.
...
var getAgentOkBodyQanMongodbMongologAgentTypeStatusPropEnum []any
...
var getAgentOkBodyQanMongodbMongologAgentTypeLogLevelPropEnum []any
...
/*
GetAgentOKBodyQANMongodbProfilerAgent QANMongoDBProfilerAgent runs within pfw-agent and sends MongoDB Query Analytics data to the Postgres1st WatchTower Server.
...
/*
GetAgentOKBodyQANMysqlPerfschemaAgent QANMySQLPerfSchemaAgent runs within pfw-agent and sends MySQL Query Analytics data to the Postgres1st WatchTower Server.
...
/*
GetAgentOKBodyQANMysqlSlowlogAgent QANMySQLSlowlogAgent runs within pfw-agent and sends MySQL Query Analytics data to the Postgres1st WatchTower Server.
...
/*
GetAgentOKBodyQANPostgresqlPgstatementsAgent QANPostgreSQLPgStatementsAgent runs within pfw-agent and sends PostgreSQL Query Analytics data to the Postgres1st WatchTower Server.
...
/*
GetAgentOKBodyQANPostgresqlPgstatmonitorAgent QANPostgreSQLPgStatMonitorAgent runs within pfw-agent and sends PostgreSQL Query Analytics data to the Postgres1st WatchTower Server.
...
/*
GetAgentOKBodyRtaMongodbAgent RTAMongoDBAgent runs within pfw-agent and sends MongoDB Real-Time Query Analytics data to the Postgres1st WatchTower Server.
swagger:model GetAgentOKBodyRtaMongodbAgent
*/
type GetAgentOKBodyRtaMongodbAgent struct {
	...
	// rta options
	RtaOptions *GetAgentOKBodyRtaMongodbAgentRtaOptions `json:"rta_options,omitempty"`
}

// Validate validates this get agent OK body rta mongodb agent
func (o *GetAgentOKBodyRtaMongodbAgent) Validate(formats strfmt.Registry) error {
	var res []error
...
var getAgentOkBodyRtaMongodbAgentTypeStatusPropEnum []any
...
func init() {
	...
	for _, v := range res {
		getAgentOkBodyRtaMongodbAgentTypeStatusPropEnum = append(getAgentOkBodyRtaMongodbAgentTypeStatusPropEnum, v)
	}
}

const (

	// GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSUNSPECIFIED captures enum value "AGENT_STATUS_UNSPECIFIED"
	GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSUNSPECIFIED string = "AGENT_STATUS_UNSPECIFIED"

	// GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSSTARTING captures enum value "AGENT_STATUS_STARTING"
	GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSSTARTING string = "AGENT_STATUS_STARTING"

	// GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSINITIALIZATIONERROR captures enum value "AGENT_STATUS_INITIALIZATION_ERROR"
	GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSINITIALIZATIONERROR string = "AGENT_STATUS_INITIALIZATION_ERROR"

	// GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSRUNNING captures enum value "AGENT_STATUS_RUNNING"
	GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSRUNNING string = "AGENT_STATUS_RUNNING"

	// GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSWAITING captures enum value "AGENT_STATUS_WAITING"
	GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSWAITING string = "AGENT_STATUS_WAITING"

	// GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSSTOPPING captures enum value "AGENT_STATUS_STOPPING"
	GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSSTOPPING string = "AGENT_STATUS_STOPPING"

	// GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSDONE captures enum value "AGENT_STATUS_DONE"
	GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSDONE string = "AGENT_STATUS_DONE"

	// GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSUNKNOWN captures enum value "AGENT_STATUS_UNKNOWN"
	GetAgentOKBodyRtaMongodbAgentStatusAGENTSTATUSUNKNOWN string = "AGENT_STATUS_UNKNOWN"
)

// prop value enum
func (o *GetAgentOKBodyRtaMongodbAgent) validateStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, getAgentOkBodyRtaMongodbAgentTypeStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *GetAgentOKBodyRtaMongodbAgent) validateStatus(formats strfmt.Registry) error {
	if swag.IsZero(o.Status) { // not required
		return nil
	}

	// value enum
	if err := o.validateStatusEnum("getAgentOk"+"."+"rta_mongodb_agent"+"."+"status", "body", *o.Status); err != nil {
		return err
	}
...
var getAgentOkBodyRtaMongodbAgentTypeLogLevelPropEnum []any
...
func init() {
	...
	for _, v := range res {
		getAgentOkBodyRtaMongodbAgentTypeLogLevelPropEnum = append(getAgentOkBodyRtaMongodbAgentTypeLogLevelPropEnum, v)
	}
}

const (

	// GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELUNSPECIFIED captures enum value "LOG_LEVEL_UNSPECIFIED"
	GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELUNSPECIFIED string = "LOG_LEVEL_UNSPECIFIED"

	// GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELFATAL captures enum value "LOG_LEVEL_FATAL"
	GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELFATAL string = "LOG_LEVEL_FATAL"

	// GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELERROR captures enum value "LOG_LEVEL_ERROR"
	GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELERROR string = "LOG_LEVEL_ERROR"

	// GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELWARN captures enum value "LOG_LEVEL_WARN"
	GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELWARN string = "LOG_LEVEL_WARN"

	// GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELINFO captures enum value "LOG_LEVEL_INFO"
	GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELINFO string = "LOG_LEVEL_INFO"

	// GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELDEBUG captures enum value "LOG_LEVEL_DEBUG"
	GetAgentOKBodyRtaMongodbAgentLogLevelLOGLEVELDEBUG string = "LOG_LEVEL_DEBUG"
)

// prop value enum
func (o *GetAgentOKBodyRtaMongodbAgent) validateLogLevelEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, getAgentOkBodyRtaMongodbAgentTypeLogLevelPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (o *GetAgentOKBodyRtaMongodbAgent) validateLogLevel(formats strfmt.Registry) error {
	if swag.IsZero(o.LogLevel) { // not required
		return nil
	}

	// value enum
	if err := o.validateLogLevelEnum("getAgentOk"+"."+"rta_mongodb_agent"+"."+"log_level", "body", *o.LogLevel); err != nil {
		return err
	}
...
func (o *GetAgentOKBodyRtaMongodbAgent) validateRtaOptions(formats strfmt.Registry) error {
	...
	if o.RtaOptions != nil {
		if err := o.RtaOptions.Validate(formats); err != nil {
			ve := new(errors.Validation)
			if stderrors.As(err, &ve) {
				return ve.ValidateName("getAgentOk" + "." + "rta_mongodb_agent" + "." + "rta_options")
			}
			ce := new(errors.CompositeError)
			if stderrors.As(err, &ce) {
				return ce.ValidateName("getAgentOk" + "." + "rta_mongodb_agent" + "." + "rta_options")
			}
...
// ContextValidate validate this get agent OK body rta mongodb agent based on the context it is used
func (o *GetAgentOKBodyRtaMongodbAgent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *GetAgentOKBodyRtaMongodbAgent) contextValidateRtaOptions(ctx context.Context, formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (o *GetAgentOKBodyRtaMongodbAgent) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetAgentOKBodyRtaMongodbAgent) UnmarshalBinary(b []byte) error {
	var res GetAgentOKBodyRtaMongodbAgent
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
/*
GetAgentOKBodyRtaMongodbAgentRtaOptions RTAOptions holds Real-Time Query Analytics agent options.
swagger:model GetAgentOKBodyRtaMongodbAgentRtaOptions
*/
type GetAgentOKBodyRtaMongodbAgentRtaOptions struct {

	// Query collect interval (default 2s is set by server).
	CollectInterval string `json:"collect_interval,omitempty"`
}

// Validate validates this get agent OK body rta mongodb agent rta options
func (o *GetAgentOKBodyRtaMongodbAgentRtaOptions) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this get agent OK body rta mongodb agent rta options based on context it is used
func (o *GetAgentOKBodyRtaMongodbAgentRtaOptions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *GetAgentOKBodyRtaMongodbAgentRtaOptions) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *GetAgentOKBodyRtaMongodbAgentRtaOptions) UnmarshalBinary(b []byte) error {
	var res GetAgentOKBodyRtaMongodbAgentRtaOptions
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
...
var getAgentOkBodyValkeyExporterTypeStatusPropEnum []any
...
/*
GetAgentOKBodyVmagent VMAgent runs on Generic or Container Node alongside pfw-agent.
// It scrapes other exporter Agents that are configured with push_metrics_enabled
// and uses Prometheus remote write protocol to push metrics to Postgres1st WatchTower Server.
