...
type ListServicesOKBodyServicesItems0AgentsItems0 struct {
	...
	// rta options
	RtaOptions *ListServicesOKBodyServicesItems0AgentsItems0RtaOptions `json:"rta_options,omitempty"`
}
...
func (o *ListServicesOKBodyServicesItems0AgentsItems0) validateRtaOptions(formats strfmt.Registry) error {
...
func (o *ListServicesOKBodyServicesItems0AgentsItems0) contextValidateRtaOptions(ctx context.Context, formats strfmt.Registry) error {
	if o.RtaOptions != nil {
...
// Validate validates this list services OK body services items0 agents items0 rta options
func (o *ListServicesOKBodyServicesItems0AgentsItems0RtaOptions) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this list services OK body services items0 agents items0 rta options based on context it is used
func (o *ListServicesOKBodyServicesItems0AgentsItems0RtaOptions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ListServicesOKBodyServicesItems0AgentsItems0RtaOptions) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ListServicesOKBodyServicesItems0AgentsItems0RtaOptions) UnmarshalBinary(b []byte) error {
	var res ListServicesOKBodyServicesItems0AgentsItems0RtaOptions
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
