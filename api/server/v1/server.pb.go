...
func (x *ChangeSettingsRequest) GetEnableInternalPgQan() bool {
	if x != nil && x.EnableInternalPgQan != nil {
		return *x.EnableInternalPgQan
	}
	return false
}
...
const file_server_v1_server_proto_rawDesc = "" +
	...
	"\x17supported_service_types\x18\x15 \x03(\tR\x15supportedServiceTypesJ\x04\b\x14\x10\x15R\x16update_snooze_duration\"\xc7\x03\n" +
