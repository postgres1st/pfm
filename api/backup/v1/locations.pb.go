...
const file_backup_v1_locations_proto_rawDesc = "" +
	"\n" +
	"\x19backup/v1/locations.proto\x12\tbackup.v1\x1a\x1aextensions/v1/redact.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"7\n" +
	"\x18FilesystemLocationConfig\x12\x1b\n" +
	"\x04path\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x04path\"\xb9\x01\n" +
	"\x10S3LocationConfig\x12#\n" +
	"\bendpoint\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\bendpoint\x12*\n" +
	"\n" +
	"access_key\x18\x02 \x01(\tB\v\xfaB\x04r\x02\x10\x01\x88\xb5\x18\x01R\taccessKey\x12*\n" +
	"\n" +
	"secret_key\x18\x03 \x01(\tB\v\xfaB\x04r\x02\x10\x01\x88\xb5\x18\x01R\tsecretKey\x12(\n" +
