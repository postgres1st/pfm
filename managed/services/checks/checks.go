...
const (
	...
	builtinAdvisorsPath  = "/opt/postgres1st/watchtower/advisors"
	builtinChecksPath    = "/opt/postgres1st/watchtower/checks"
...
func (s *Service) processResults(ctx context.Context, aCheck check.Check, target services.Target, queryResults []any) ([]services.CheckResult, error) {
	...
	cmd := exec.CommandContext(cmdCtx, "pfw-managed-starlark")
