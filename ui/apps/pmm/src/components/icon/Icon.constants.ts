export const DYNAMIC_ICON_IMPORT_MAP = {
  ...
  intelligence: () => import('icons/pfmm-intelligence.svg?react'),
  inventory: () => import('icons/inventory.svg?react'),
  'pfmm-mo': () => import('icons/pfmm-mo.svg?react'),
  'pfmm-my': () => import('icons/pfmm-my.svg?react'),
  node: () => import('icons/home.svg?react'),
  overview: () => import('icons/overview.svg?react'),
  'pfmm-po': () => import('icons/pfmm-po.svg?react'),
  'pfmm-titled': () => import('icons/pfmm-titled.svg?react'),
  'pfmm-titled-outlined': () => import('icons/pfmm-titled-outlined.svg?react'),
  'pfmm-rounded': () => import('icons/pfmm-rounded.svg?react'),
  ...
  pfmm: () => import('icons/pfmm.svg?react'),
  ...
  'pfmm-va': () => import('icons/pfmm-va.svg?react'),
