export const DYNAMIC_ICON_IMPORT_MAP = {
  ...
  intelligence: () => import('icons/pfw-intelligence.svg?react'),
  inventory: () => import('icons/inventory.svg?react'),
  'pfw-mo': () => import('icons/pfw-mo.svg?react'),
  'pfw-my': () => import('icons/pfw-my.svg?react'),
  node: () => import('icons/home.svg?react'),
  overview: () => import('icons/overview.svg?react'),
  'pfw-po': () => import('icons/pfw-po.svg?react'),
  'pfw-titled': () => import('icons/pfw-titled.svg?react'),
  'pfw-titled-outlined': () => import('icons/pfw-titled-outlined.svg?react'),
  'pfw-rounded': () => import('icons/pfw-rounded.svg?react'),
  ...
  pfw: () => import('icons/pfw.svg?react'),
  ...
  'pfw-va': () => import('icons/pfw-va.svg?react'),
...
> = {
  ...
  'pfw-rounded': '0 0 160 160',
  'pfw-titled': '0 0 48 48',
  'pfw-titled-outlined': '0 0 252 113',
