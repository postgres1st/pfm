...
describe('HomeLink', () => {
  it('navigates to Postgres1st WatchTower Home if client update is not pending', () => {
    render(
  ...
  it('navigates to Postgres1st WatchTower Home if client update is not pending on new UI', () => {
    render(
      wrapWithUpdatesProvider(
        <MemoryRouter
